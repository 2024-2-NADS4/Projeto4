...
# Salvar os dados do idoso no banco de dados
...
# Salvar os dados do cuidador no banco de dados
...
# Menu para escolher o tipo de usuário que será cadastrado
repetirMenu = True
